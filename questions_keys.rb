...
# 
# http://syntone.ru/prytesty/test-logicheskogo-myshleniya
# 
# Версия с соблюдением стандартов форматирования кода ruby

# Объявим константу QUESTION с массивом вопросов теста (каждый элемент
